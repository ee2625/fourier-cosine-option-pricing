...
REF     = 22.318945791474590                                # paper Section 5.2
...
def warm_ms(N):
    """Mean per-call ms with cache primed."""
...
def _print_text(results, all_ok):
    ...
    print()
    print("PASS: Heston algorithm beats Table 5 on error, cold, and warm runtime." if all_ok
