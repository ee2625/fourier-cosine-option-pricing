...
class CgmyModel:
    ...
    def bsm_control_variate_adjustment(self, strike, spot, texp, cp=1, n_cos=128, L=10.0, vol_method="simple"):
    ...
    def price_cv(self, strike, spot, texp, cp=1, n_cos=128, L=10.0, vol_method="simple"):
